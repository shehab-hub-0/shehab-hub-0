...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=200&section=header&text=Shehab%20Eldin%20Ahmed&fontSize=42&fontColor=ffffff&fontAlignY=38&desc=Data%20Engineer%20%7C%20Pipeline%20Architect&descSize=16&descAlignY=60&animation=fadeIn"/>
...
| **🏥 Real-time Healthcare Pipeline** | `Kafka` `Spark Streaming` `Azure Event Hubs` `Databricks` | Graduation project — streaming pipeline to predict & reduce hospital congestion via real-time patient flow data |
